...
report_utilization -hierarchical -file reports/$NAME\_$PART\_utilization.rpt

set REPORT_TARGET [get_cells iob_memwrapper/iob_soc_tester_inst/SUT0]
report_utilization -cells $REPORT_TARGET -hierarchical -file reports/$NAME\_$PART\_utilization_SUT0.rpt
