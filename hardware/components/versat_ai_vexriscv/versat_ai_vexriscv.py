...
sys.path.append(f"{os.path.dirname(os.path.abspath(__file__))}/hardware/simulation")
...
def setup(py_params_dict):
  ...
  VexRiscvAxi4PlicClint CPU (
      .externalResetVector(resetVector_i),
      // CLINT
...
"""
    ...
    # Disable linter for `VexRiscvAxi4PlicClint.v` source.
    if py_params_dict.get("py2hwsw_target", "") == "setup":
...
lint_off -file "*/VexRiscvAxi4PlicClint.v"
"""
            )
